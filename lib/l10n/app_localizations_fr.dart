...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get scenes_sort_group_scene_number => 'Numéro de scène dans le groupe/film';
  ...
  @override
  String get filter_not_matches_regex => 'Ne correspond pas à l\'expression régulière';
  ...
  @override
  String get settings_interface_use_actual_scene_video_miniplayer => 'Utiliser la vraie vidéo de scène dans le mini-lecteur';

  @override
  String get settings_interface_use_actual_scene_video_miniplayer_subtitle => 'Affiche la surface vidéo en direct au lieu de la capture de la scène quand la lecture est active.';

  @override
  String get settings_interface_entity_image_filtering => 'Filtrage d\'images d\'entité';

  @override
  String get settings_interface_entity_image_filtering_subtitle => 'Choisissez si les pages d\'images d\'entité correspondent aux métadonnées d\'image ou aux galeries associées.';

  @override
  String get settings_interface_entity_image_filtering_direct => 'Entité directe';

  @override
  String get settings_interface_entity_image_filtering_galleries => 'Galeries associées';
  ...
  @override
  String get settings_playback_feed_random => 'Démarrer le flux à partir d\'une position aléatoire';

  @override
  String get settings_playback_feed_random_subtitle => 'Lors de la lecture de scènes en mode Flux, démarrer à une position aléatoire entre 0% et 90% de la durée de la vidéo';

  @override
  String get settings_playback_resume_position => 'Reprendre à partir de la dernière position de jeu';

  @override
  String get settings_playback_resume_position_subtitle => 'Lors de l\'ouverture d\'une vidéo, reprenez automatiquement là où vous vous étiez arrêté';
  ...
  @override
  String get settings_develop_enable_logging => 'Activer le journal de débogage';

  @override
  String get settings_develop_enable_logging_subtitle => 'Enregistrer les journaux de l\'application pour le dépannage';
  ...
  @override
  String get main_startup_failed_desc => 'Un service de démarrage a échoué avant que l\'application puisse terminer son initialisation.Redémarrez l\'application après avoir vérifié les diagnostics.';
  ...
  @override
  String get settings_security_enable_app_lock => 'Activer le verrouillage des applications';

  @override
  String get settings_security_enable_app_lock_subtitle => 'Exiger un mot de passe lors de la reprise/du lancement de l\'application.';

  @override
  String get settings_security_lock_on_launch => 'Verrouiller le lancement de l\'application';

  @override
  String get settings_security_lock_on_launch_subtitle => 'Demandez le mot de passe immédiatement lorsque l\'application s\'ouvre.';

  @override
  String get settings_security_background_lock_timer => 'Minuterie de verrouillage en arrière-plan';

  @override
  String get settings_security_background_lock_timer_subtitle => 'Combien de temps l\'application peut rester en arrière-plan avant de se verrouiller.';

  @override
  String get settings_security_set_passcode => 'Définir le mot de passe';

  @override
  String get settings_security_passcode_prompt => 'Code d\'accès (4 à 8 chiffres)';

  @override
  String get settings_security_confirm_passcode => 'Confirmer';

  @override
  String get settings_security_error_numeric => 'Utilisez uniquement des chiffres, d\'une longueur de 4 à 8.';

  @override
  String get settings_security_error_mismatch => 'Les codes d\'accès ne correspondent pas.';
  ...
  @override
  String get settings_security_subtitle => 'Paramètres de verrouillage de l\'application et du code';

  @override
  String get settings_security_app_lock => 'Verrouillage d\'application';

  @override
  String get settings_security_app_lock_subtitle => 'Protégez l’accès avec un mot de passe après la mise en arrière-plan.';
  ...
  @override
  String get tools_section_subtitle => 'Flux de travail de maintenance et de métadonnées pour les scènes.';

  @override
  String get tools_scene_deduplication_subtitle => 'Rechercher et gérer les scènes en double.';

  @override
  String get tools_scene_tagger_subtitle => 'Scraper les pages de scènes actuelles avec Stash-box.';
  ...
  @override
  String get only_select_matching_codecs => 'Sélectionnez uniquement les codecs correspondants';

  @override
  String get select_scenes => 'Sélectionnez des scènes';

  @override
  String get all_but_largest_resolution => 'Toutes les résolutions, sauf la plus grande';
  ...
  @override
  String get delete_scene_confirm => 'Êtes-vous sûr de vouloir supprimer cette scène ?';
  ...
  @override
  String get existing_names_are_overwritten => 'Les noms existants seront écrasés';

  @override
  String get active_settings_saved_server => 'Les paramètres actuellement actifs seront enregistrés sur le serveur.';
  ...
  @override
  String get delete_scenes_help => 'Choisissez si vous voulez supprimer uniquement les métadonnées Stash ou aussi les fichiers de scène et les fichiers auxiliaires générés.';
  ...
  @override
  String get merge_editing_not_wired => 'L\'édition des fusions n\'est pas encore câblée dans StashFlow.';
  ...
  @override
  String get no_matched_scenes_yet => 'Aucune scène correspondante pour le moment.';

  @override
  String get no_scenes_match_configuration => 'Aucune scène ne correspond à cette configuration.';
  ...
  @override
  String get stats_library_stats_tooltip => 'Appui long pour les statistiques de la bibliothèque';
