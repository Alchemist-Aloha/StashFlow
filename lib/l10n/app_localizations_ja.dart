...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get settings_interface_use_actual_scene_video_miniplayer => 'ミニプレーヤーで実際のシーン動画を使用';

  @override
  String get settings_interface_use_actual_scene_video_miniplayer_subtitle => '再生中はシーンのスクリーンショットの代わりにライブ動画サーフェスを表示します。';

  @override
  String get settings_interface_entity_image_filtering => 'エンティティ画像フィルタリング';

  @override
  String get settings_interface_entity_image_filtering_subtitle => 'エンティティ画像ページが画像メタデータと一致するか、関連ギャラリーと一致するかを選択します。';
  ...
  @override
  String get settings_playback_feed_random_subtitle => 'フィードモードでシーンを再生するとき、動画の長さの0%から90%の間のランダムな位置から開始します';

  @override
  String get settings_playback_resume_position => '最後に再生した位置から再開';

  @override
  String get settings_playback_resume_position_subtitle => 'ビデオを開くと、中断したところから自動的に再開します';
  ...
  @override
  String get settings_develop_enable_logging_subtitle => 'トラブルシューティング用にアプリのログを記録します';
  ...
  @override
  String get main_startup_failed_desc => 'アプリの初期化が完了する前に、スタートアップ サービスが失敗しました。診断を確認した後、アプリを再起動します。';
  ...
  @override
  String get settings_security_enable_app_lock_subtitle => 'アプリの再開/起動時にパスコードを要求します。';

  @override
  String get settings_security_lock_on_launch => 'アプリ起動時にロックする';

  @override
  String get settings_security_lock_on_launch_subtitle => 'アプリを開いたらすぐにパスコードを要求します。';

  @override
  String get settings_security_background_lock_timer => 'バックグラウンドロックタイマー';

  @override
  String get settings_security_background_lock_timer_subtitle => 'アプリがロックされるまでにバックグラウンドに留まることができる時間。';
  ...
  @override
  String get settings_security_app_lock_subtitle => 'バックグラウンド化後はパスコードでアクセスを保護します。';
  ...
  @override
  String get tools_scene_tagger_subtitle => 'Stash-boxを使用して現在のシーンページをスクレイピングします。';
  ...
  @override
  String get delete_scenes_help => 'Stash のメタデータのみを削除するか、シーンファイルと生成された補助ファイルも削除するかを選択してください。';
