...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get settings_interface_use_actual_scene_video_miniplayer => '미니플레이어에서 실제 장면 비디오 사용';

  @override
  String get settings_interface_use_actual_scene_video_miniplayer_subtitle => '재생 중일 때 장면 스크린샷 대신 실시간 비디오 화면을 표시합니다.';

  @override
  String get settings_interface_entity_image_filtering => '엔티티 이미지 필터링';

  @override
  String get settings_interface_entity_image_filtering_subtitle => '엔티티 이미지 페이지가 이미지 메타데이터와 일치하는지 관련 갤러리와 일치하는지 선택하세요.';
  ...
  @override
  String get settings_playback_feed_random_subtitle => '피드 모드에서 장면을 재생할 때 비디오 길이의 0%에서 90% 사이의 임의의 위치에서 시작합니다';

  @override
  String get settings_playback_resume_position => '마지막 재생 위치에서 다시 시작';

  @override
  String get settings_playback_resume_position_subtitle => '비디오를 열 때 중단한 부분부터 자동으로 다시 시작';
  ...
  @override
  String get settings_develop_enable_logging_subtitle => '문제 해결을 위해 앱 로그를 기록합니다';
  ...
  @override
  String get main_startup_failed_desc => '앱 초기화가 완료되기 전에 시작 서비스가 실패했습니다.진단을 확인한 후 앱을 다시 시작하세요.';
  ...
  @override
  String get settings_security_enable_app_lock_subtitle => '앱 재개/실행 시 비밀번호가 필요합니다.';

  @override
  String get settings_security_lock_on_launch => '앱 실행 시 잠금';

  @override
  String get settings_security_lock_on_launch_subtitle => '앱이 열리면 즉시 비밀번호를 요청하세요.';

  @override
  String get settings_security_background_lock_timer => '백그라운드 잠금 타이머';

  @override
  String get settings_security_background_lock_timer_subtitle => '앱이 잠기기 전에 백그라운드에 머무를 수 있는 시간입니다.';
  ...
  @override
  String get delete_scenes_help => 'Stash 메타데이터만 제거할지, 장면 파일과 생성된 보조 파일까지 함께 삭제할지 선택하세요.';
