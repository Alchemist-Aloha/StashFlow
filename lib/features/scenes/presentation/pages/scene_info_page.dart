        ...
        children: [
            ...
            Wrap(
              ...
              children: [
                ...
                if (scene.organized) _InfoChip(icon: Icons.check_circle_rounded, text: context.l10n.organized_title),
                if (scene.interactive) _InfoChip(icon: Icons.touch_app_rounded, text: context.l10n.interactive_title),
              ],
            ),
