...
void main() {
  testWidgets('Responsive utility identifies mobile and tablet widths', (tester) async {
    ...
    await tester.pumpWidget(MediaQuery(
      ...
      child: MaterialApp(
        home: Builder(builder: (context) {
          expect(Responsive.isMobile(context), isTrue, reason: 'Should be mobile at 400px');
    ...
    await tester.pumpWidget(MediaQuery(
      ...
      child: MaterialApp(
        home: Builder(builder: (context) {
          expect(Responsive.isMobile(context), isFalse, reason: 'Should not be mobile at 800px');
          expect(Responsive.isTablet(context), isTrue, reason: 'Should be tablet at 800px');
          return const SizedBox();
        }),
      ),
    ));
